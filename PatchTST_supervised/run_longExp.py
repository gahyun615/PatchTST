...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--use_weekend_embedding",
        type=int,
        default=1,
        help="PatchTST: day-of-week embedding; 1 True 0 False",
    )
    parser.add_argument(
        "--use_time_concat",
        type=int,
        default=0,
        help="TimeXer-style: concat time (month,day,weekday,hour) with patch then linear; 1 True 0 False",
    )
    parser.add_argument(
        "--time_dim",
        type=int,
        default=4,
        help="time feature dim when use_time_concat (default 4: month,day,weekday,hour)",
    )
